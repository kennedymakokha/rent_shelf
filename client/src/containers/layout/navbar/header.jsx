        ...
        <div className='flex gap-x-2'>
          ...
          {userInfo?.role === "owner" &&
            <div className='sm:flex hidden rounded-sm items-center justify-center text-[18px]  font-semi-bold px-2 '>
              <div onClick={() => addListings()} className='flex gap-x-2  items-center justify-between text-[18px] border-secondary-100 hover:border-slate-200 bg-transparent hover:bg-primary-100 rounded-sm font-semibold px-4 border text-[gray] hover:text-white  '>
                <span className='group-hover:text-secondary-100 text-white '>Add Listing</span>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-5 h-5 group-hover:text-secondary-100 text-slate-200">
