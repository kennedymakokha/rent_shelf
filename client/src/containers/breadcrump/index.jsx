...
function index(props) {
    return (
        ...
        <div className="bg-gray-400 w-full h-[200px] relative z-0">
            ...
            <div className="absolute top-0 left-0 w-full  h-full sm:opacity-50 opacity-10 sm:bg-black bg-white z-4">
            ...
            <div className={`absolute sm:w-[26%]  w-[80%]   
             ${props.detailed ? "sm:top-4 top-6  sm:left-[10%] left-10  shadow-md opacity-90  text-white bg-black" : "sm:top-28 top-40  sm:left-10 -left-20  shadow-md opacity-90  shadow-md   text-primary-100 bg-white   flex justify-center items-center"}    z-40`}>
                <div className={`absolute  text-center   ${props.detailed ? "text-white sm:text-3xl  text-xl  underline" : "text-black bg-white opacity-60 sm:rounded-bl-[5px] sm:rounded-tr-[5px] sm:py-2 px-3 text-2xl font-bold capitalize"} sm:px-10 px-2 flex-col  flex justify-center items-center z-44`}>
            ...
            {props.detailed && <div className="absolute sm:w-[26%]  w-[100%]  sm:left-40  left-10   top-[30%]  shadow-md opacity-90  text-white bg-black   z-40">
                ...
                {props.detailed && <div className="absolute      text-white  gap-x-2 sm:gap-y-2  flex justify-center items-center z-44">
                    <span className='flex gap-x-1 justify-center items-center'> <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.0" stroke="currentColor" className="w-4 h-4">
