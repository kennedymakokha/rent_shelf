...
export const DropDown = ({ title, array }) => {
    return (
        <div className="px-10 text-[18px]">
            <div className="dropdown  bg-transparent inline-block relative  rounded-full">
                <button className="bg-transparent text-white  hover:text-primary-100 font-semibold py-2 px-4  inline-flex items-center">
