        ...
        <>
            ...
            <div className='flex sm:flex-row flex-col gap-y-2  px-6 w-full'>
                {data?.types?.map((type, i) => (
                    <span key={i} className='w-auto flex text-slate-400 items-center justify-centter'><div><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6  flex sm:hidden">
