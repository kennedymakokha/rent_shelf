                    ...
                    <div className="fixed inset-0 z-10 overflow-y-auto">
                        ...
                        <div className="flex items-center min-h-screen px-4 py-8">
                            <div className="relative w-full max-w-lg  mx-auto bg-white rounded-md shadow-lg">
                                ...
                                <div class="absolute top-4 right-4 flex justify-center  bg-slate-100 hover:bg-primary-300 w-5 h-5 rounded-full  items-center z-10" onClick={() =>setShowModal(false)}>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M6 18 18 6M6 6l12 12" />
                                    </svg>

                                </div>
                                <div class="absolute top-[25%] bottom-[25%] w-full flex justify-between px-2 items-center z-10" >
                                    <div
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 hover:text-primary-100 text-white">
